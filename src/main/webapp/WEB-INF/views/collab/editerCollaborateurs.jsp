			...
			<div class="col-2  offset-8 align-self-center">
				<div class="form-check">
					<input class="form-check-input" type="checkbox" value=""
						id="desactiver" name="desactiver"> <label class="form-check-label"
		...
		<div class="countainer-fluid px-1">
					...
					<div class="accordion" id="accordionExample">
						<div class="card">
							...
							<div id="collapseOne" class="collapse show"
								...
								<div class="card-body">
									<form class="form-group" method="POST" action="creer.html">
										<div class="row">
										...
										<div class="row">
											...
											<div class="col-12 col-lg-4 form-group">
												<textarea input type="text" id="adresse" value=""
								...
								<div class="card-body">
									<form class="form-group" method="POST" action="creer.html">
										<div class="row">
											...
											<div class="col-12 col-lg-4 form-group">
												<select name="departement" class="form-control" id="exampleFormControlSelect1">
										...
										<div class="row">
											...
											<div class="col-12 col-lg-4 form-group">
												<input type="text" id="nom" name="poste" class="form-control">
											</div>
										</div>
									</form>
								</div>
			...
			<div class="row mt-3">
				<div class="col offset-10">
					<input class="btn btn-secondary" type="submit" " value="Sauvegarder">
				</div>
			</div>
